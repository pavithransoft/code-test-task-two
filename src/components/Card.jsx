...
const Card = (props) => {
  ...
  return (
    <div
      className="md:h-36 lg:h-40 rounded-lg bg-white border grid md:grid-cols-[20%,80%] py-3 cursor-pointer text-xs md:text-sm lg:text-base px-2 hover:border-[#E54065] active:bg-[#F2F2F2] focus:bg-[#F2F2F2]"
